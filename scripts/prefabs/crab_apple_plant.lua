...
local function setupstump(inst)
    SpawnPrefab("crab_apple_stump").Transform:SetPosition(inst.Transform:GetWorldPosition())
    inst:Remove()
end
...
local function tree_burnt(inst)
    local burnt_tree = SpawnPrefab("crab_apple_burnt")
...
local function stump_fn()
    ...
    inst:SetPrefabNameOverride("crab_apple_tree")
...
return Prefab("crab_apple_tree", tree_fn, assets, prefabs_tree),
    Prefab("crab_apple_burnt", burnt_fn, assets, prefabs_burnt),
    Prefab("crab_apple_stump", stump_fn, assets, prefabs_stump)
